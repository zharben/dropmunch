# Vagrant box for dropmunch project
# Adapted from https://github.com/jackdb/pg-app-dev-vm.git
#
# Includes :
# * ubuntu 14.04
# * latest postgresql package (>9.4)
#
# To customize postgres database name and password, edit :
#   Vagrant-setup/bootstrap.sh
#
# Original instructions from "pg-app-dev-vm" included below.
...
Then, run the following to create a new PostgreSQL app dev virtual machine:
	...
	# Clone it locally:
    $ git clone https://github.com/jackdb/pg-app-dev-vm drop
